...
# Game parameters
parser.add_argument("--num_cards", type=int, default=4, help="Number of cards of the game. Should be at least 3") 
...
def main():
  ...
  game = JaxGoofspiel(args.num_cards)
  model_save_dir = args.model_save_dir
  game_name = game.game_name() 
  
  if not model_save_dir:
      model_save_dir = f"/trained_networks/{game_name}/seed{args.trajectory_seed}/network_seed{args.network_seed}/"
